...
$orderedModes = [
    new AltMode(AltMode::TYPE_VEHICLE),
    new AltMode(AltMode::TYPE_MACHINE),
    new AltMode(AltMode::TYPE_WEAPON),
    new AltMode(AltMode::TYPE_PRIMITIVE),
];
                ...
                <thead>
                    <tr>
                        ...
                        @foreach ($orderedModes as $mode)
                            <th class="mode-{{ $mode->mode }}" scope="col">
                                {{ $mode }}
                            </th>
                        @endforeach
                    </tr>
