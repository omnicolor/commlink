...
namespace Modules\Expanse\Providers;
 ...
 */
class ExpanseServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'Expanse';
    protected string $moduleNameLower = 'expanse';
