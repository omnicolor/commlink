...
namespace Modules\Battletech\Providers;
 ...
 * @codeCoverageIgnore
 */
class BattletechServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'Battletech';

    protected string $moduleNameLower = 'battletech';
