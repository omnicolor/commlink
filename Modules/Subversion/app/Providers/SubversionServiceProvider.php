...
namespace Modules\Subversion\Providers;
 ...
 */
class SubversionServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'Subversion';
    protected string $moduleNameLower = 'subversion';
